    ...
    return (
        <div className="features">
            ...
            <ul className="ul-feature">
                ...
                <li className="li-feature"><span className="li-feature"></span>View all expenses</li>
                <li className="li-feature"><span className="li-feature"></span>Simplify debts</li>
                <li className="li-feature"><span className="li-feature"></span>Calculate total balances</li>
                <li className="li-feature"><span className="li-feature"></span>Categorize expenses</li>
            </ul>
        </div>
    )
}